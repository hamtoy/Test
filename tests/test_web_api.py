...
class TestOCREndpoint:
    ...
    def test_get_ocr_exists(self, client):
    ...
    def test_get_ocr_missing(self, client):
...
class TestQAGeneration:
    ...
    def test_generate_single_valid(self, client):
    ...
    def test_generate_single_invalid_type(self, client):
...
class TestEvaluation:
    ...
    def test_evaluate_external_valid(self, client):
    ...
    def test_evaluate_external_no_answers(self, client):
    ...
    def test_evaluate_external_too_many_answers(self, client):
...
class TestWorkspace:
    ...
    def test_workspace_inspect(self, client):
    ...
    def test_workspace_edit(self, client):
    ...
    def test_workspace_edit_missing_request(self, client):
