...
@pytest.mark.asyncio
async def test_evaluate_external_answers_basic(mock_agent):
...
@pytest.mark.asyncio
async def test_evaluate_external_answers_scores(mock_agent):
...
@pytest.mark.asyncio
async def test_evaluate_external_answers_score_clamping(mock_agent):
...
@pytest.mark.asyncio
async def test_evaluate_external_answers_negative_score_clamping(mock_agent):
...
@pytest.mark.asyncio
async def test_evaluate_external_answers_invalid_score(mock_agent):
...
@pytest.mark.asyncio
async def test_evaluate_external_answers_no_ocr(mock_agent):
...
@pytest.mark.asyncio
async def test_evaluate_external_answers_api_error(mock_agent):
...
@pytest.mark.asyncio
async def test_evaluate_external_answers_prompt_structure(mock_agent):
...
@pytest.mark.asyncio
async def test_evaluate_external_answers_feedback_parsing(mock_agent):
...
@pytest.mark.asyncio
async def test_evaluate_external_answers_multiline_response(mock_agent):
