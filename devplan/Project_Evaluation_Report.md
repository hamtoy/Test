...
| **최근 분석일** | 2025-11-30 19:17 |
| **파일 수** | 579 |
| **디렉토리 수** | 92 |
| **주요 언어** | Python (py: 343개, md: 46개, html: 19개, js: 12개, json: 15개) |
...
6. **RAG 모듈 분리**: `src/qa/graph/` 패키지로 Neo4j 연결, 벡터 검색, 규칙 추출 분리
...
### ⚠️ 개선 필요 영역
1. **rag_system.py 추가 분리**: 여전히 1022줄로 추가 리팩토링 권장
2. **Sphinx 문서 자동화**: CI 통합 및 자동 배포 설정 필요
3. **Docstring 통일**: Google 스타일로 완전 통일 진행 중
