...
class TestBatchProcessor:
    ...
    def test_create_batch_request(self, processor):
    ...
    def test_create_batch_request_with_custom_id(self, processor):
    ...
    def test_build_jsonl(self, processor):
    ...
    def test_create_batch_job(self, processor):
        """Test creating a batch job."""
        requests = [
    ...
    @pytest.mark.asyncio
    async def test_submit_batch_job(self, processor):
    ...
    @pytest.mark.asyncio
    async def test_submit_batch_job_missing_file(self, processor):
    ...
    @pytest.mark.asyncio
    async def test_poll_batch_job(self, processor):
    ...
    def test_cleanup_with_file_deletion(self, processor):
