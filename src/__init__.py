"""Main package initialization with module shims for backward compatibility.

This module provides compatibility shims for modules that were reorganized
into subpackages. Tests and other code can still import them from src directly.
"""
