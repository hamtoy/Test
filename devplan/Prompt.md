...
|:---:|:---|:---|:---:|:---:|
| 1 | PROMPT-001 | Decouple optional Neo4j dependency from base install | P1 | ✅ Done |
| 2 | PROMPT-002 | Add CI gate for minimal (no-extras) install | P2 | ✅ Done |
| 3 | PROMPT-003 | Unskip Web API tests by mocking LLM calls | P2 | ✅ Done |
| 4 | PROMPT-004 | Sync docs with current scripts and commands | P2 | ✅ Done |
| 5 | PROMPT-005 | Make CORS origins configurable via env | P2 | ✅ Done |
| 6 | PROMPT-006 | Wire OpenTelemetry initialization (optional) | P3 | ✅ Done |
| 7 | PROMPT-007 | Add Web endpoint for cache stats summary | P3 | ✅ Done |
| 8 | OPT-1 | Stream cache stats analytics (JSONL) | OPT | ✅ Done |

Total: 8 prompts | Completed: 8 | Remaining: 0
