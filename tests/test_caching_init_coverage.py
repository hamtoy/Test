...
class TestCachingPackageLazyImports:
    ...
    def test_caching_layer_lazy_import(self):
    ...
    def test_analyze_cache_stats_lazy_import(self):
    ...
    def test_print_cache_report_lazy_import(self):
    ...
    def test_redis_eval_cache_lazy_import(self):
